...
public:
     ...
     */
    void update_stat_sheet(std::unordered_map<std::string, int> new_stat_sheet)
    {
     ...
     * @param new_stat_sheet
     */
    bool compare_incoming_statistics(std::unordered_map<std::string, int> new_stat_sheet)
    {
     ...
     * @param filepath
     */
    std::unordered_map<std::string, int> evaluate_memory_stat_sheet(std::string filepath);
     ...
     */
    std::unordered_map<std::string, int> size_metrics_data(nlohmann::json &page, std::unordered_map<std::string, int> &stat_sheet);
     ...
     */
    void update_application_statistics(std::unique_ptr<ApplicationObj> &app, std::unordered_map<std::string, int> stat_sheet);
